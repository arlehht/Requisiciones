...
namespace Requisiciones.Controllers
{
    public class Table_1Controller : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Fecha,NoRequisicion,Area,Tipo,EntregarEn,Prioridad,FechaSurtido,CompraServicio")] Table_1 table_1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Fecha,NoRequisicion,Area,Tipo,EntregarEn,Prioridad,FechaSurtido,CompraServicio")] Table_1 table_1)
        {
            if (ModelState.IsValid)
            {
